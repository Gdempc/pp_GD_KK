    ...
    public partial class UserControl4 : UserControl
    {
        ...
        private void UserControl4_Load(object sender, EventArgs e)
        {
            foreach (string s in strings)
            {
                ...
                PictureBox pictureBox = new PictureBox { Height = p.Height - 10, Width = p.Height - 10, Image = Resources.latest, SizeMode = PictureBoxSizeMode.StretchImage, BackColor = Color.White };
